...
// import TableFormBtn from '/@/components/tableformbtn/index.vue';
// import DialogTitle from '/@/components/dialogtitle/index.vue';
// import addForm from '/@/components/addForm/index.vue';
// import icon from '/@/components/icon/index.vue';
//
// // 所有组件列表
// const components = [systemTable, rtdpButton, TableActionBar, TableFormBtn, DialogTitle, addForm, icon]
//
